...
def main(): 
    ...
    ttf_searchfolder = '..\\ttf_fonts\\google-fonts\\ofl\\k2d\\'
    
    #ttf_searchfolder = '..\\ttf_fonts\\other_ttf\\' 
    
    #ttf_searchfolder = '..\\ttf_fonts\\liberation-fonts-ttf\\' 
    
    output_filepath = "..\\bmh_fonts"
    ...
    for ttf_file in TTF_FILES: 
        for height_idx in height_indices: 
            ...
            if not (os.path.exists(output_filepath + '\\' + Font)): 

                    os.mkdir(output_filepath + '\\' + Font)

            ttf_fontpath = output_filepath + '\\' + Font 
